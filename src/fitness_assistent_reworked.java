...
{ 	groeße_string = groeße_string.replace("m","");//Maßeinheit entfernen
    ...
    //(2)
public static double pruefeWertebereichGroeße (double groeße, Scanner scanner)//Hilfsmethode prüft Wertebereich Größe
{   String groeße_string;

	while (groeße>2.1||groeße<1.0)//While Schleife wenn Zahlenwerte außerhalb 1.00 und 2.10 Metern angegeben sind
	{System.out.println("");
